package com.navdeventerprise.nevdev.data.usertype;
...
public class JsonbUserType implements UserType, ParameterizedType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        try {
            ...
            throw new RuntimeException("Failed to convert String to " + returnedClass() + e.getMessage(), e);
        }
    }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session) throws HibernateException, SQLException {
        if (value == null) {
            ...
            try {
                ...
                throw new RuntimeException("Failed to convert " + returnedClass() + " to String " + e.getMessage(), e);
            }
        }
    }
