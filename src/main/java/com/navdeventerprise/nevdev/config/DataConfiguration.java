package com.navdeventerprise.nevdev.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.navdeventerprise.nevdev.data.repository"})
@EnableTransactionManagement
public class DataConfiguration {

    private static final String[] ENTITY_PACKAGES = {
            "com.navdeventerprise.nevdev.data.entity"
    };
    ...
    @Value("${jpa.properties.hibernate.entity_dirtiness_strategy:com.navdeventerprise.nevdev.data.strategy.EntityDirtinessStrategy}")
